...
/* This SAS snippet uses PROC FREQ to generate frequency tables for the GENDER variable from the CLASS dataset. */
PROC FREQ DATA=CLASS;
TABLES GENDER;
RUN;

/* This SAS snippet uses PROC FREQ to generate frequency tables for the COURSENO variable from the CLASS dataset. */
PROC FREQ DATA=CLASS;
TABLES COURSENO;
RUN;